...
async function insertarAlumno(formData) {
  ...
  await connection.query(
    "insert into alumnos (nombre, localidad, fechaNacimiento) values (?,?,?)",
          ...
          >
            ...
            <div className="flex gap-6">
              <form>
                ...
                <button>
                  <Link href={`/alumnos-bd/${alumno.id}`}>
                    <FaMagnifyingGlass />
                  </Link>
                </button>
                <button className="mr-5 ml-5" title="MODIFICAR">
                  <Link href={`/alumnos-bd/${alumno.id}/modificar`}>
                    <FaPencilAlt />
                  </Link>
                </button>
